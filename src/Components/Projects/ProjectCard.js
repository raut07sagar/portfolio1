  ...
  return (
    ...
    >
      <div className="project-card">
        ...
        <div className="livve">
        <a  href={project.projectUrl} target="_blank" className="codde" ><button>view live</button> </a>
        <a href={project.projectgit}  target="_blank"  className="codde"><button>view code</button> </a>
