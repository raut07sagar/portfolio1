...
function ExperienceCard({ experience }) {
 ...
 const cert = {marginLeft:"3rem", color:"orange"}
  ...
  return (
    <div id="time_line_5cf90ca818f641" className="time_line-item  item_show">
      ...
      <div className="time_line-content">
        ...
        <h4 className="time_line-title">GUVI Geek Network Private Limited</h4>
        ...
        <div className="languages">
          <div className="languages-profile">
            <div className="languages-name">
              ...
              })}<a href={experience.url} style={cert} target="_blank" >view certifivcate</a>
            </div> 
